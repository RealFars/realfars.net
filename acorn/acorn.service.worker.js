...
/** @type {string} */
const CACHE_VERSION = '1760269699|2322333871';
/** @type {string} */
const CACHE_PREFIX = 'acorn-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'acorn.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["acorn.html","acorn.js","acorn.offline.html","acorn.icon.png","acorn.apple-touch-icon.png","acorn.audio.worklet.js","acorn.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["acorn.wasm","acorn.pck"];
